...
function generateRandomTitle() {
    ...
    var title = part2 + (part1[Math.floor(Math.random() * (part1.length + 1))]);
    return title;
}
...
function generateRandomDescription() {
    let sentences = [
        ...
        "Vestibulum ligula arcu, pretium sit amet arcu sit amet, lacinia iaculis dui. Suspendisse ultricies hendrerit erat et consequat.",
        ...
        "Fusce finibus molestie massa in congue. Curabitur porttitor tincidunt ipsum, et pretium orci sodales sit amet. ",
        "Ut vel mi vitae augue accumsan laoreet. Curabitur pharetra fermentum dapibus. Quisque sodales eget nisl vel blandit.",
        ...
        "Nam eu pharetra nulla, vitae commodo dolor. Sed ac erat cursus felis ornare placerat. Mauris id dolor lorem.",
        ...
        "Nam ut ex sed arcu congue pharetra at id nisi. Sed vel molestie massa. Aliquam a ligula nunc. Donec ac lobortis felis.",

        "Proin tempor orci a turpis dapibus, quis bibendum urna pellentesque.",
        "Phasellus eget magna vel ipsum dignissim condimentum. Duis vel urna est. Duis dapibus est ut erat commodo sodales.",
        "Nunc ut tincidunt diam, id porttitor magna. Etiam ut gravida leo.",

        "Sed sollicitudin non nisl ac placerat. Maecenas euismod porttitor nulla eu dapibus.",
        "Vestibulum vel volutpat nisi, eget consequat lacus. In ipsum magna, ultrices sed dapibus vel, hendrerit in est.",
